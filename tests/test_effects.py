...
class TestEffects:
    ...
    def test_add_custom_effect_adds_effect(self):
        ...
        assert effect_name in effects.effects
        assert effects._effects[effect_name] == "01b41600"
    ...
    def test_add_custom_effect_adds_effect_when_mode_is_2(self):
        ...
        assert effect_name in effects.effects
        assert effects._effects[effect_name] == "0213b400"
